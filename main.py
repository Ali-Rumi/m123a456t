...
class TradingStrategy:
    ...
    def run_bnb_long(self):
        try:
            subprocess.Popen(["python", "matic_long.py"])
            print("Running matic_long.py")
        except Exception as e:
            print(f"Error running matic_long.py: {e}")

    def run_bnb_short(self):
        try:
            subprocess.Popen(["python", "matic_short.py"])
            print("Running matic_short.py")
        except Exception as e:
            print(f"Error running matic_short.py: {e}")
